...
class ProductLoader {
    class var products : [Product] {
        return [
            ...
            Product(id: "3", name: "Leather Driver Saddle Loafers", color: "Tan", category: "Men’s Footwear", price: 34, quantity: 12, images: ["http://localhost:3000/public/images/LeatherDriverSaddleLoafers.jpg", "http://localhost:3000/public/images/LeatherDriverSaddleLoafers_thumb.jpg"]),
            ...
            Product(id: "11", name: "Lightweight Patch Pocket Blazer - Deer", color: "Tan", category: "Men's Formalwear", price: 175.50, quantity: 1, images: ["http://localhost:3000/public/images/LightweightPocketBlazer.jpg", "http://localhost:3000/public/images/LightweightPocketBlazer_thumb.jpg"]),
...
//    {
//    "pid": 13,
//    "name": "Mid Twist Cut-Out",
//    "color": "Pink",
//    "images": [
//    "public/images/MidTwistCutDress.jpg",
//    "public/images/MidTwistCutDress_thumb.jpg"
//    ],
